...
//            // المجلد الفعلي الذي ينتج بعد فك ضغط ملف الـ Zip الرسمي
...
//
//            // إعطاء صلاحيات التشغيل للملف التنفيذي على أنظمة Linux/Mac
//            if (!osutiles.getCurrentOs().equals(osutiles.OPERATING.WINDOWS)) {
...
//            }
//
//            // مسح ملف الـ Zip المضغوط بعد انتهاء الاستخراج الناجح لتوفير المساحة
//            try {
...
//        String version = lazyLoader.version;
//        // تصحيح الاسم من allure_ إلى allure- ليتطابق تماماً مع اسم الفولدر الناتج عن فك الضغط
...
//                // استخدام المسار بدون وضع فاصل يدوي زائد لتفادي مشاكل أنظمة التشغيل المختلفة
